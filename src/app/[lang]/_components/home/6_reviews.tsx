...
const videoReviews = [
  {
    id: 1,
    imageSrc: '/images/home/reviews/patient-1.png',
    imageAlt: 'patient-1',
    patientName: 'ㅇㅇㅇ님',
    gender: '남성',
    age: 42,
...
export default function HomeReviews() {
  ...
  return (
    <section
      className="mt-15 pb-10 max-w-7xl
    xl:mx-auto"
    >
      <FadeInUp>
        <div className="px-5">
      ...
      >
        <ul
          className="pr-5 flex items-center gap-2 whitespace-nowrap overflow-scroll
"
        >
            ...
            return (
              <li key={category}>
                <button
                  ...
                  className={`px-5 py-3.5 rounded-full font-semibold text-[15px]
          ${isActive ? 'bg-[#1B705B] text-white' : 'bg-[#EEF6F3] text-[#1B705B]'}
          `}
                >
                  {category}
                </button>
      ...
      <div className="mt-4 px-5">
        ...
        >
          ...
          >
            ...
            >
              <Image src="/images/home/reviews/more.svg" alt="more-btn" fill />
            </div>
          </div>
      ...
      <div className="mt-5 px-5">
        <Link
          target="_blank"
          href={`/`}
          className="py-2.5 flex justify-center items-center gap-2 rounded-lg border border-[#D3BBA2] font-semibold text-sm text-[#D3BBA2]
          xl:hidden"
        >
      ...
      <div
        className="mt-15 px-5 flex gap-4 overflow-x-scroll
