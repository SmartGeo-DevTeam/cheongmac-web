...
const patientReviews = [
  {
    id: 1,
    imageSrc: '/images/home/reviews/1-after.png',
    patientName: '김*숙 님',
    age: 34,
    gender: '여성',
  ...
  {
    id: 2,
    imageSrc: '/images/home/reviews/1-before.png',
    patientName: '김*숙 님',
    age: 34,
    gender: '여성',
    treatment: '레이저 정맥 폐쇄술 + 경화요법',
...
const thumbnails = [
  {
    ...
    imageUrl: '/images/doctors/temp-thumbnail-1.png',
    path: '/',
  },
  {
    id: 2,
    title: '일상을 바꾸다',
    imageUrl: '/images/doctors/temp-thumbnail-2.png',
    path: '/',
  },
  {
    id: 3,
    title: '왜 해?! 자궁적출',
    imageUrl: '/images/doctors/temp-thumbnail-3.png',
    path: '/',
  },
] as const;
...
const thesis = [
  {
    ...
    imageUrl: '/images/doctors/temp-thesis.png',
    path: '/',
  },
  {
    id: 2,
  ...
  return (
    <div className={className}>
      <h3
        ...
        xl:before:bg-[url('/common/symbol.svg')] xl:before:bg-contain xl:before:bg-center xl:before:bg-no-repeat"
      >
        {title}
      </h3>
      {children}
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image
            src={`/images/doctors/temp-thumbnail-0.png`}
