    ...
    >
      <LegalSection title="[제1장] 총칙">
        ...
        <LegalArticle title="제2조 (용어의 정의)">
          <TypographyP>이 약관에서 사용하는 용어의 뜻은 다음과 같습니다.</TypographyP>
          <TermsList>
            <li>
        ...
        <LegalArticle title="제3조 (약관의 게시 및 변경)">
          <TypographyP>병원은 이 약관을 홈페이지에서 이용자가 확인할 수 있도록 게시합니다.</TypographyP>
          <TypographyP>
            병원은 관련 법령을 위반하지 않는 범위에서 약관을 개정할 수 있으며, 개정 시 시행일 최소
            7일 전에 홈페이지에 공지합니다.
          </TypographyP>
          <TypographyP>회원이 개정 약관에 동의하지 않는 경우 이용계약의 해지를 요청할 수 있습니다.</TypographyP>
        </LegalArticle>
      </LegalSection>
      ...
      <LegalSection title="[제2장] 이용계약">
        ...
        <LegalArticle title="제5조 (회원가입)">
          ...
          <TypographyP>회원가입은 본인의 실제 정보를 사용하여야 하며, 만 14세 미만은 가입할 수 없습니다.</TypographyP>
          <TypographyP>
      ...
      <LegalSection title="[제5장] 계약 해지 및 이용 제한">
        <LegalArticle title="제14조 (회원 탈퇴 및 이용 제한)">
          ...
          <TypographyP>병원은 회원이 약관을 위반한 경우 이용을 제한하거나 이용계약을 해지할 수 있습니다.</TypographyP>
        </LegalArticle>
      </LegalSection>
      ...
      <LegalSection title="부칙">
        <TypographyP>이 약관은 2026년 9월 8일부터 시행합니다.</TypographyP>
      </LegalSection>
    </LegalPageLayout>
  );
}
