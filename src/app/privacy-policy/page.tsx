    ...
    >
          <div className="flex flex-col">
            <p className="order-2 mx-auto mt-6 max-w-420 break-keep text-[15px] leading-[1.75] tracking-[-0.02em] text-[#555555] xl:order-1 xl:mt-0 xl:text-center xl:text-xl xl:leading-[1.9]">
              ...
              『개인정보 보호법』을 엄격히 준수하고 있습니다.
              <br />
              <br className="block xl:hidden" />본 개인정보 처리방침은
              정보주체(환자·이용자)께서 제공하시는 개인정보가 어떠한 목적과
              방식으로 처리되고 있는지, 그리고 안전한 관리를 위해 어떠한 보호
              조치가 취해지고 있는지 투명하게 안내해 드립니다. 청맥병원은 언제나
              환자분의 알 권리를 존중하며, 정보주체의 권익 보호에 최선을
              다하겠습니다.
            </p>
          ...
          <LegalSection title="1. 개인정보의 처리 목적">
            ...
            <PolicyList>
              <li>
                <b>홈페이지 회원 가입 및 관리</b>: 회원제 서비스 이용에 따른
              ...
              <li>
                <b>민원 처리</b>: 민원인의 신원 확인, 민원사항 확인, 처리결과
                통보
              </li>
              <li>
                <b>마케팅 및 정보 제공(선택)</b>: 병원 소식, 질병 정보, 건강
                콘텐츠 안내, 만족도 조사
              </li>
            </PolicyList>
          </LegalSection>
          ...
          <LegalSection title="2. 처리하는 개인정보의 항목 및 수집 방법">
            <p>
              ...
              구분하여 처리합니다. 상세 내용은 아래 항목을 펼쳐 확인하실 수
              있습니다.
            </p>
            ...
            <p className="text-[11px] leading-[1.65] text-[#999999] xl:text-[11px]">
              ...
              있으며, 법령상 보존 의무가 있는 경우에는 해당 기간 동안
              보관합니다.
            </p>
          ...
          <LegalSection title="3. 개인정보의 제3자 제공">
            <p>
              ...
              범위를 초과하여 이용하거나 제3자에게 제공하지 않습니다. 다만,
              정보주체가 사전에 제3자 제공에 동의한 경우 또는 법률에 특별한
              규정이 있는 경우에는 예외로 합니다.
            </p>
            <p>
            ...
            <PolicyList>
              <li>
                통계작성, 학술연구 등의 목적으로 특정 개인을 알아볼 수 없는
                형태로 가공하여 제공하는 경우
              </li>
          ...
          <LegalSection title="6. 정보주체와 법정대리인의 권리·의무 및 행사 방법">
            ...
            <PolicyList>
              ...
              <li>
                ...
                경우, 정정·삭제를 완료할 때까지 해당 개인정보를 이용하거나
                제공하지 않습니다.
              </li>
              <li>
              ...
              <li>
                관련 법령에 따라 보존 의무가 있는 개인정보는 열람·정정·삭제
                요구가 제한될 수 있습니다.
              </li>
            </PolicyList>
          </LegalSection>
          ...
          <LegalSection title="8. 개인정보 자동 수집 장치의 설치·운영 및 웹 분석 도구 사용">
            <p>
              ...
              개선을 위해 Google LLC의 웹 분석 도구인 Google Analytics를 사용할
              수 있습니다.
            </p>
            ...
            <PolicyList>
              ...
              <li>
                ...
                저장 시마다 확인을 거치거나, 저장을 거부할 수 있습니다.
              </li>
              <li>
                다만 쿠키 저장을 거부할 경우 일부 맞춤형 서비스 이용에 제한이
                있을 수 있습니다.
              </li>
            </PolicyList>
            ...
            <p>
              청맥병원의 웹사이트 방문과 서비스 이용 현황 분석을 위해 Google
              LLC의 웹 분석 도구인 Google Analytics를 사용할 수 있습니다.
            </p>
            <PolicyList>
              <li>
                구글 애널리틱스는 쿠키를 이용하여 이용자의 홈페이지 방문·이용
                관련 정보를 비식별 형태로 수집하고 통계 분석 목적으로
                이용합니다.
              </li>
              <li>
                수집된 정보는 Google의 개인정보처리방침에 따라 처리되며,
                Google의 분석 서비스 정책이 적용될 수 있습니다.
              </li>
              <li>
                이용자는 브라우저의 쿠키 설정 또는 Google에서 제공하는 차단
          ...
          <LegalSection title="9. 개인정보의 안전성 확보 조치">
            ...
            <PolicyList>
              <li>
                관리적 조치: 내부관리계획 수립·시행, 개인정보 취급 인원 최소화
                및 정기적인 담당자 교육
              </li>
              <li>
                기술적 조치: 개인정보처리시스템 접근권한 관리, 접근통제시스템
                설치, 고유식별정보 등의 암호화, 보안프로그램 설치 및 갱신
              </li>
              <li>
                물리적 조치: 개인정보가 보관된 시설 및 문서보관 장소에 대한
                접근통제
              </li>
            </PolicyList>
          </LegalSection>
          ...
          <LegalSection title="10. 개인정보 보호책임자 및 담당부서">
            <p>
              ...
              문의·불만·피해구제 등을 개인정보 보호책임자 및 담당부서로 문의하실
              수 있으며, 청맥병원은 이에 대해 지체 없이 답변 및 처리하겠습니다.
            </p>
          ...
          <LegalSection title="11. 정보주체의 권익침해에 대한 구제 방법">
            ...
            <PolicyList>
              ...
              <li>
                <strong>개인정보침해신고센터(한국인터넷진흥원):</strong>{' '}
                (국번없이) 118 /{' '}
                <Link
          ...
          <LegalSection title="12. 개인정보 처리방침의 변경에 관한 사항">
            <p>
              ...
              전에 청맥병원 홈페이지를 통해 변경 이유 및 내용을 공지합니다.
            </p>
            <PolicyList>
