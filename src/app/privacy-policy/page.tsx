...
function SectionSubTitle({ children }: ChildrenProps) {
  return <TypographyH3 className="font-semibold text-[#444444]">{children}</TypographyH3>;
}
  ...
  return (
    ...
    >
      <div className="flex flex-col">
        <TypographyP className="order-2 mx-auto mt-6 max-w-7xl break-keep text-[15px] leading-[1.75] tracking-[-0.02em] text-[#555555] xl:order-1 xl:mt-0 xl:text-center xl:text-xl xl:leading-[1.9]">
      ...
      <LegalSection title="1. 개인정보의 처리 목적">
        ...
        <PolicyList>
          <li>
            <TypographyBold>홈페이지 회원 가입 및 관리</TypographyBold>: Google·NAVER·Kakao 소셜 계정을 통한
            회원 식별·인증, 홈페이지 회원 전환, 회원자격 유지·관리, 서비스 부정이용 방지
          </li>
          <li>
            <TypographyBold>홈페이지 서비스 운영 및 개선</TypographyBold>: 로그인 회원의 페이지 방문·이동,
            실제 활동 시간과 주요 기능 이용 흐름을 분석하여 서비스 품질 개선
          </li>
          <li>
            <TypographyBold>진료 예약 및 상담</TypographyBold>: 진료 예약 접수·확인, 온라인
            상담(의학상담·고객의 소리) 처리 및 결과 회신
          </li>
          <li>
            <TypographyBold>의료 서비스 제공</TypographyBold>: 진료, 검사, 치료 등 의료 서비스 제공 및
            관련 안내
          </li>
          <li>
            <TypographyBold>민원 처리</TypographyBold>: 민원인의 신원 확인, 민원사항 확인, 처리결과 통보
          </li>
          <li>
            <TypographyBold>마케팅 및 정보 제공(선택)</TypographyBold>: 병원 소식, 질병 정보, 건강 콘텐츠
            안내, 만족도 조사
          </li>
        </PolicyList>
      </LegalSection>
      ...
      <LegalSection title="2. 처리하는 개인정보의 항목 및 수집 방법">
        ...
        <TypographyP className="text-[11px] leading-[1.65] text-[#999999] xl:text-[11px]">
      ...
      <LegalSection title="5. 개인정보의 파기 절차 및 방법">
        ...
        <PolicyList>
          <li>
            <TypographyStrong>파기 절차:</TypographyStrong> 파기 사유가 발생한 개인정보를 선정하고,
            개인정보 보호책임자의 승인을 받아 파기합니다.
          </li>
          <li>
            <TypographyStrong>파기 방법:</TypographyStrong> 전자적 파일 형태의 정보는 기록을 재생할
      ...
      <LegalSection title="11. 정보주체의 권익침해에 대한 구제 방법">
        ...
        <PolicyList>
          <li>
            <TypographyStrong>개인정보분쟁조정위원회:</TypographyStrong> (국번없이) 1833-6972 /{' '}
            <Link
          ...
          <li>
            <TypographyStrong>개인정보침해신고센터(한국인터넷진흥원):</TypographyStrong> (국번없이)
            118 /{' '}
            <Link
          ...
          <li>
            <TypographyStrong>대검찰청 사이버수사과:</TypographyStrong> (국번없이) 1301 /{' '}
            <Link
          ...
          <li>
            <TypographyStrong>경찰청 사이버수사국:</TypographyStrong> (국번없이) 182 /{' '}
            <Link
