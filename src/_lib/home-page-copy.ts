...
export const HOME_PAGE_COPY_FIELDS: readonly InlineContentField[] = [
  text('coverSlide1TitleLead', '커버 1 - 제목 앞 문구'),
  text('coverSlide1TitleStrong', '커버 1 - 강조 제목'),
  text('coverSlide1Description1', '커버 1 - 설명 1'),
  text('coverSlide1Description2', '커버 1 - 설명 2'),
  text('coverSlide1Button', '커버 1 - 버튼'),

  text('coverSlide2TitleLead', '커버 2 - 제목 앞 문구'),
  text('coverSlide2TitleStrong', '커버 2 - 강조 제목'),
  text('coverSlide2Description1', '커버 2 - 설명 1'),
  text('coverSlide2Description2', '커버 2 - 설명 2'),
  text('coverSlide2Button', '커버 2 - 버튼'),

  text('coverSlide3TitleLead', '커버 3 - 제목 앞 문구'),
  text('coverSlide3TitleStrong', '커버 3 - 강조 제목'),
  text('coverSlide3Description1', '커버 3 - 설명 1'),
  text('coverSlide3Description2', '커버 3 - 설명 2'),
  text('coverSlide3Button', '커버 3 - 버튼'),

  text('coverPopup1Title', '팝업 1 - 제목'),
  text('coverPopup1Line1', '팝업 1 - 내용 1'),
  text('coverPopup1Line2', '팝업 1 - 내용 2'),
  text('coverPopup2Title', '팝업 2 - 제목'),
  text('coverPopup2Line1', '팝업 2 - 내용 1'),
  text('coverPopup2Line2', '팝업 2 - 내용 2'),
  text('coverPopup3Title', '팝업 3 - 제목'),
  text('coverPopup3Line1', '팝업 3 - 내용 1'),
  text('coverPopup3Line2', '팝업 3 - 내용 2'),
